...
describe("createPenguinsCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createPenguinsCodingTools({
      config,
    ...
    const anthropicTools = createPenguinsCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createPenguinsCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createPenguinsCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
