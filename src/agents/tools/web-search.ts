...
type WebSearchConfig = NonNullable<PenguinsConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: PenguinsConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("penguins configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.penguins.ai/tools/web",
  };
}
...
async function runPerplexitySearch(params: {
  ...
  const res = await fetch(endpoint, {
    ...
    headers: {
      ...
      "HTTP-Referer": "https://penguins.ai",
      "X-Title": "Penguins Web Search",
    },
