...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolvePenguinsAgentDir() returns mainAgentDir
    process.env.PENGUINS_STATE_DIR = tmpDir;
    process.env.PENGUINS_AGENT_DIR = mainAgentDir;
