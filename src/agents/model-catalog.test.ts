...
vi.mock("./models-config.js", () => ({
  ensurePenguinsModelsJson: vi.fn().mockResolvedValue({ agentDir: "/tmp", wrote: false }),
}));

vi.mock("./agent-paths.js", () => ({
  resolvePenguinsAgentDir: () => "/tmp/penguins",
}));
...
describe("loadModelCatalog", () => {
  ...
  it("returns partial results on discovery errors", async () => {
    ...
    const result = await loadModelCatalog({ config: {} as PenguinsConfig });
