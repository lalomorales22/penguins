...
function resolveWatchPaths(workspaceDir: string, config?: PenguinsConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: PenguinsConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: PenguinsConfig }) {
