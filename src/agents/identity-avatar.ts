...
function resolveAvatarSource(cfg: PenguinsConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: PenguinsConfig, agentId: string): AgentAvatarResolution {
