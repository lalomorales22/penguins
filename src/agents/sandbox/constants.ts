...
export const DEFAULT_SANDBOX_IMAGE = "penguins-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "penguins-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "penguins-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "penguins-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "penguins-sbx-browser-";
