...
import type { PenguinsPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: PenguinsPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: PenguinsPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
