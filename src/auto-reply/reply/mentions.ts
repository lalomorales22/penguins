...
function resolveMentionPatterns(cfg: PenguinsConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: PenguinsConfig | undefined, agentId?: string): RegExp[] {
