...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@penguins", { botUsername: "penguins" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@penguins args", {
        botUsername: "penguins",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@penguins: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "penguins" })).toBe(
      "/help@otherbot",
    );
  });
