import type { PenguinsConfig } from "./config.js";
...
function isTelegramConfigured(cfg: PenguinsConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: PenguinsConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: PenguinsConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: PenguinsConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: PenguinsConfig): boolean {
...
function isIMessageConfigured(cfg: PenguinsConfig): boolean {
...
function isWhatsAppConfigured(cfg: PenguinsConfig): boolean {
...
function isGenericChannelConfigured(cfg: PenguinsConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: PenguinsConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: PenguinsConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: PenguinsConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: PenguinsConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: PenguinsConfig, pluginId: string): PenguinsConfig {
...
function registerPluginEntry(cfg: PenguinsConfig, pluginId: string): PenguinsConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
