import type { PenguinsConfig } from "./types.js";
...
function resolveAnthropicDefaultAuthMode(cfg: PenguinsConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: PenguinsConfig): PenguinsConfig {
...
export function applyTalkApiKey(config: PenguinsConfig): PenguinsConfig {
...
export function applyModelDefaults(cfg: PenguinsConfig): PenguinsConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: PenguinsConfig): PenguinsConfig {
...
export function applyLoggingDefaults(cfg: PenguinsConfig): PenguinsConfig {
...
export function applyContextPruningDefaults(cfg: PenguinsConfig): PenguinsConfig {
...
export function applyCompactionDefaults(cfg: PenguinsConfig): PenguinsConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
