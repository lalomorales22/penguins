...
export type PenguinsPluginConfigSchema = {
...
export type PenguinsPluginToolContext = {
...
export type PenguinsPluginToolFactory = (
  ctx: PenguinsPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type PenguinsPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type PenguinsPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<PenguinsConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type PenguinsPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current Penguins configuration */
  config: PenguinsConfig;
 ...
 */
export type PenguinsPluginCommandDefinition = {
...
export type PenguinsPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type PenguinsPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;
...
export type PenguinsPluginCliRegistrar = (ctx: PenguinsPluginCliContext) => void | Promise<void>;

export type PenguinsPluginServiceContext = {
  config: PenguinsConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type PenguinsPluginService = {
  id: string;
  start: (ctx: PenguinsPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: PenguinsPluginServiceContext) => void | Promise<void>;
};

export type PenguinsPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type PenguinsPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: PenguinsPluginConfigSchema;
  register?: (api: PenguinsPluginApi) => void | Promise<void>;
  activate?: (api: PenguinsPluginApi) => void | Promise<void>;
};

export type PenguinsPluginModule =
  | PenguinsPluginDefinition
  | ((api: PenguinsPluginApi) => void | Promise<void>);

export type PenguinsPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | PenguinsPluginToolFactory,
    opts?: PenguinsPluginToolOptions,
  ) => void;
  registerHook: (
  ...
  registerService: (service: PenguinsPluginService) => void;
   ...
   */
  registerCommand: (command: PenguinsPluginCommandDefinition) => void;
