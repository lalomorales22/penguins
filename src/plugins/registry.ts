...
export type PluginToolRegistration = {
  pluginId: string;
  factory: PenguinsPluginToolFactory;
  names: string[];
  optional: boolean;
  source: string;
};
...
export type PluginCliRegistration = {
  pluginId: string;
  register: PenguinsPluginCliRegistrar;
  commands: string[];
  source: string;
};
...
export type PluginServiceRegistration = {
  pluginId: string;
  service: PenguinsPluginService;
  source: string;
};

export type PluginCommandRegistration = {
  pluginId: string;
  command: PenguinsPluginCommandDefinition;
  source: string;
};
...
export function createPluginRegistry(registryParams: PluginRegistryParams) {
  ...
  const registerTool = (
    ...
    const factory: PenguinsPluginToolFactory =
      typeof tool === "function" ? tool : (_ctx: PenguinsPluginToolContext) => tool;
  ...
  const registerHook = (
    ...
    opts: PenguinsPluginHookOptions | undefined,
    config: PenguinsPluginApi["config"],
  ) => {
  ...
  const registerChannel = (
    record: PluginRecord,
    registration: PenguinsPluginChannelRegistration | ChannelPlugin,
  ) => {
    const normalized =
      typeof (registration as PenguinsPluginChannelRegistration).plugin === "object"
        ? (registration as PenguinsPluginChannelRegistration)
  ...
  const registerCli = (
    record: PluginRecord,
    registrar: PenguinsPluginCliRegistrar,
  ...
  const registerService = (record: PluginRecord, service: PenguinsPluginService) => {
  ...
  const registerCommand = (record: PluginRecord, command: PenguinsPluginCommandDefinition) => {
