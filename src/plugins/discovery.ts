...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @penguins/voice-call -> voice-call).
...
export function discoverPenguinsPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".penguins", "extensions")];
