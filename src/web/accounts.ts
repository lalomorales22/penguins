...
function listConfiguredAccountIds(cfg: PenguinsConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: PenguinsConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: PenguinsConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: PenguinsConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: PenguinsConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: PenguinsConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: PenguinsConfig): ResolvedWhatsAppAccount[] {
