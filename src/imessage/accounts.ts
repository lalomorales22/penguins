...
export function listIMessageAccountIds(cfg: PenguinsConfig): string[] {
...
export function resolveDefaultIMessageAccountId(cfg: PenguinsConfig): string {
...
function mergeIMessageAccountConfig(cfg: PenguinsConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: PenguinsConfig): ResolvedIMessageAccount[] {
