...
export function listSignalAccountIds(cfg: PenguinsConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: PenguinsConfig): string {
...
function mergeSignalAccountConfig(cfg: PenguinsConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: PenguinsConfig): ResolvedSignalAccount[] {
