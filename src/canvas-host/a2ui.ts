...
export const A2UI_PATH = "/__penguins__/a2ui";

export const CANVAS_HOST_PATH = "/__penguins__/canvas";

export const CANVAS_WS_PATH = "/__penguins__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.penguinsCanvasA2UIAction.postMessage(...)
  // - Android: window.penguinsCanvasA2UIAction.postMessage(...)
  const handlerNames = ["penguinsCanvasA2UIAction"];
  ...
  globalThis.Penguins = globalThis.Penguins ?? {};
  globalThis.Penguins.postMessage = postToNode;
  globalThis.Penguins.sendUserAction = sendUserAction;
  globalThis.penguinsPostMessage = postToNode;
  globalThis.penguinsSendUserAction = sendUserAction;
