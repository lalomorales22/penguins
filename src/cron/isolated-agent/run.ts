...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/penguins/penguins/issues/15692
   */
  delivered?: boolean;
};
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.PENGUINS_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.penguins/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: PenguinsConfig = {
    ...params.cfg,
