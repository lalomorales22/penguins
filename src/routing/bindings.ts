...
export function listBindings(cfg: PenguinsConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: PenguinsConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: PenguinsConfig) {
