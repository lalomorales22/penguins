...
const OPENCLAW_REPO_URL = "https://github.com/penguins/penguins.git";
...
export async function ensureGitCheckout(params: {
  ...
  if (!(await isGitCheckout(params.dir))) {
    ...
    if (!empty) {
      throw new Error(
        `OPENCLAW_GIT_DIR points at a non-git directory: ${params.dir}. Set OPENCLAW_GIT_DIR to an empty folder or an penguins checkout.`,
      );
    }
