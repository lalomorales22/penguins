...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.penguins.ai/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.penguins.ai/cli/agents")}\n`,
    );
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['penguins agents set-identity --agent main --name "Penguins" --emoji "🦞"', "Set name + emoji."],
  ["penguins agents set-identity --agent main --avatar avatars/penguins.png", "Set avatar path."],
  [
    "penguins agents set-identity --workspace ~/.penguins/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "penguins agents set-identity --identity-file ~/.penguins/workspace/IDENTITY.md --agent main",
