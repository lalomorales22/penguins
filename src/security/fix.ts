...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof PenguinsConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: PenguinsConfig; env: NodeJS.ProcessEnv }): {
  cfg: PenguinsConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
