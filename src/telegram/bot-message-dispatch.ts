...
import type { PenguinsConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: PenguinsConfig, agentId: string) {
  try {
