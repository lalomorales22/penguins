...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.PENGUINS_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: PenguinsConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: PenguinsConfig): string {
...
function mergeTelegramAccountConfig(cfg: PenguinsConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: PenguinsConfig): ResolvedTelegramAccount[] {
