...
import { type PenguinsConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: PenguinsConfig): string[] {
...
export function listAgentsForGateway(cfg: PenguinsConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: PenguinsConfig): string {
...
function resolveSessionStoreAgentId(cfg: PenguinsConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: PenguinsConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: PenguinsConfig): GatewaySessionsDefaults {
