...
import type { PenguinsConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: PenguinsConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: PenguinsConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: PenguinsConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: PenguinsConfig) => void;
  log: {
