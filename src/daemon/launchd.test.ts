...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.penguins.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", PENGUINS_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    const env: Record<string, string | undefined> = {
      HOME: "/Users/test",
      PENGUINS_PROFILE: "default",
    };
    const repair = await repairLaunchAgentBootstrap({ env });
    expect(repair.ok).toBe(true);

    const domain = typeof process.getuid === "function" ? `gui/${process.getuid()}` : "gui/501";
    const label = "ai.penguins.gateway";
...
describe("resolveLaunchAgentPlistPath", () => {
  it("uses default label when PENGUINS_PROFILE is default", () => {
    const env = { HOME: "/Users/test", PENGUINS_PROFILE: "default" };
    expect(resolveLaunchAgentPlistPath(env)).toBe(
      "/Users/test/Library/LaunchAgents/ai.penguins.gateway.plist",
    );
  });

  it("uses default label when PENGUINS_PROFILE is unset", () => {
  ...
  it("uses profile-specific label when PENGUINS_PROFILE is set to a custom value", () => {
    const env = { HOME: "/Users/test", PENGUINS_PROFILE: "jbphoenix" };
    expect(resolveLaunchAgentPlistPath(env)).toBe(
      "/Users/test/Library/LaunchAgents/ai.penguins.jbphoenix.plist",
    );
  });

  it("prefers PENGUINS_LAUNCHD_LABEL over PENGUINS_PROFILE", () => {
    const env = {
      HOME: "/Users/test",
      PENGUINS_PROFILE: "jbphoenix",
      PENGUINS_LAUNCHD_LABEL: "com.custom.label",
    };
    expect(resolveLaunchAgentPlistPath(env)).toBe(
  ...
  it("trims whitespace from PENGUINS_LAUNCHD_LABEL", () => {
    const env = {
      HOME: "/Users/test",
      PENGUINS_LAUNCHD_LABEL: "  com.custom.label  ",
    };
  ...
  it("ignores empty PENGUINS_LAUNCHD_LABEL and falls back to profile", () => {
    const env = {
      HOME: "/Users/test",
      PENGUINS_PROFILE: "myprofile",
      PENGUINS_LAUNCHD_LABEL: "   ",
    };
    expect(resolveLaunchAgentPlistPath(env)).toBe(
      "/Users/test/Library/LaunchAgents/ai.penguins.myprofile.plist",
    );
  });
  ...
  it("trims whitespace from PENGUINS_PROFILE", () => {
    const env = { HOME: "/Users/test", PENGUINS_PROFILE: "  myprofile  " };
    expect(resolveLaunchAgentPlistPath(env)).toBe(
      "/Users/test/Library/LaunchAgents/ai.penguins.myprofile.plist",
    );
  });
