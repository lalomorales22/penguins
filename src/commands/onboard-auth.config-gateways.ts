...
export function applyVercelAiGatewayProviderConfig(cfg: PenguinsConfig): PenguinsConfig {
...
export function applyVercelAiGatewayConfig(cfg: PenguinsConfig): PenguinsConfig {
