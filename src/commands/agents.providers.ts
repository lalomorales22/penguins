...
function resolveDefaultAccountId(cfg: PenguinsConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: PenguinsConfig): boolean {
...
export function summarizeBindings(cfg: PenguinsConfig, bindings: AgentBinding[]): string[] {
