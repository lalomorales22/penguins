...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "penguins-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<PenguinsConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<PenguinsConfig["telegram"]>>,
