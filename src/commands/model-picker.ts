...
type PromptDefaultModelResult = { model?: string; config?: PenguinsConfig };
...
function resolveConfiguredModelRaw(cfg: PenguinsConfig): string {
...
function resolveConfiguredModelKeys(cfg: PenguinsConfig): string[] {
...
export function applyPrimaryModel(cfg: PenguinsConfig, model: string): PenguinsConfig {
...
export function applyModelAllowlist(cfg: PenguinsConfig, models: string[]): PenguinsConfig {
  const defaults = cfg.agents?.defaults;
