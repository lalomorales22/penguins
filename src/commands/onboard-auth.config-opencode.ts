...
export function applyOpencodeZenProviderConfig(cfg: PenguinsConfig): PenguinsConfig {
...
export function applyOpencodeZenConfig(cfg: PenguinsConfig): PenguinsConfig {
