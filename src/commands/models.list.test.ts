...
const ensurePenguinsModelsJson = vi.fn().mockResolvedValue(undefined);
const resolvePenguinsAgentDir = vi.fn().mockReturnValue("/tmp/penguins-agent");
...
vi.mock("../config/config.js", () => ({
  ...
  STATE_DIR: "/tmp/penguins-state",
  loadConfig,
}));

vi.mock("../agents/models-config.js", () => ({
  ensurePenguinsModelsJson,
}));

vi.mock("../agents/agent-paths.js", () => ({
  resolvePenguinsAgentDir,
}));
