...
export function applyOpenrouterProviderConfig(cfg: PenguinsConfig): PenguinsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: PenguinsConfig): PenguinsConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: PenguinsConfig): PenguinsConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: PenguinsConfig): PenguinsConfig {
...
export function applyMoonshotConfig(cfg: PenguinsConfig): PenguinsConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: PenguinsConfig): PenguinsConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: PenguinsConfig): PenguinsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: PenguinsConfig): PenguinsConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: PenguinsConfig): PenguinsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: PenguinsConfig): PenguinsConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: PenguinsConfig): PenguinsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: PenguinsConfig): PenguinsConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: PenguinsConfig): PenguinsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: PenguinsConfig): PenguinsConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: PenguinsConfig): PenguinsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: PenguinsConfig): PenguinsConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: PenguinsConfig): PenguinsConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: PenguinsConfig): PenguinsConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: PenguinsConfig): PenguinsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: PenguinsConfig): PenguinsConfig {
...
export function applyQianfanProviderConfig(cfg: PenguinsConfig): PenguinsConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: PenguinsConfig): PenguinsConfig {
