...
import type { PenguinsPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverPenguinsPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, PenguinsPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["PENGUINS_PLUGIN_CATALOG_PATHS", "OPENCLAW_PLUGIN_CATALOG_PATHS", "OPENCLAW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<PenguinsPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: PenguinsPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: PenguinsPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverPenguinsPlugins({ workspaceDir: options.workspaceDir });
