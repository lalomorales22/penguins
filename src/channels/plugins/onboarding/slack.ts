...
function setSlackDmPolicy(cfg: PenguinsConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "Penguins";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for Penguins`,
    },
    features: {
      bot_user: {
...
function setSlackAllowFrom(cfg: PenguinsConfig, allowFrom: string[]): PenguinsConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
