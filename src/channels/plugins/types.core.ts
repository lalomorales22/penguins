...
export type ChannelAgentToolFactory = (params: { cfg?: PenguinsConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: PenguinsConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: PenguinsConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: PenguinsConfig }) => boolean;
  supportsCards?: (params: { cfg: PenguinsConfig }) => boolean;
