...
export function listSlackAccountIds(cfg: PenguinsConfig): string[] {
...
export function resolveDefaultSlackAccountId(cfg: PenguinsConfig): string {
...
function mergeSlackAccountConfig(cfg: PenguinsConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: PenguinsConfig): ResolvedSlackAccount[] {
