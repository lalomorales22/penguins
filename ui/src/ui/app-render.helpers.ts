...
function resetChatStateForSessionSwitch(state: AppViewState, sessionKey: string) {
  ...
  (state as unknown as PenguinsApp).chatStreamStartedAt = null;
  state.chatRunId = null;
  (state as unknown as PenguinsApp).resetToolStream();
  (state as unknown as PenguinsApp).resetChatScroll();
  state.applySettings({
    ...state.settings,
    sessionKey,
  ...
  return html`
    <div class="chat-controls">
      ...
      <button
        ...
        @click=${async () => {
          const app = state as unknown as PenguinsApp;
