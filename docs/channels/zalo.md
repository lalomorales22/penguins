...
- Install via CLI: `penguins plugins install @penguins/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `penguins plugins install ./extensions/zalo`
   - From npm (if published): `penguins plugins install @penguins/zalo`
...
- Approve via:
  - `penguins pairing list zalo`
  - `penguins pairing approve zalo <CODE>`
...
- Example: `penguins message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `penguins channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `penguins logs --follow`
