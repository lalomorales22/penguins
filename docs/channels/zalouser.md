...
read_when:
  - Setting up Zalo Personal for Penguins
...
- Install via CLI: `penguins plugins install @penguins/zalouser`
- Or from a source checkout: `penguins plugins install ./extensions/zalouser`
...
- `penguins pairing list zalouser`
- `penguins pairing approve zalouser <code>`
...
- On startup, Penguins resolves group/user names in allowlists to IDs and logs the mapping; unresolved entries are kept as typed.
...
- Re-login: `penguins channels logout --channel zalouser && penguins channels login --channel zalouser`
