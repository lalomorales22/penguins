...
- Same path: run the app from a fixed location (for Penguins, `dist/Penguins.app`).
...
Workaround: move files into the Penguins workspace (`~/.penguins/workspace`) if you want to avoid per-folder grants.
