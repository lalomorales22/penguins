...
This guide summarizes a sane workflow for working on the pi integration in Penguins.
...
- Trigger the agent directly:
  - `pnpm penguins agent --message "Hello" --thinking low`
...
- [https://docs.penguins.ai/testing](https://docs.penguins.ai/testing)
- [https://docs.penguins.ai/start/getting-started](https://docs.penguins.ai/start/getting-started)
