...
Penguins treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.penguins/settings/voicewake.json`

Shape:

```json
{ "triggers": ["penguins", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
