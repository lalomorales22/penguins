...
read_when:
  - You are building a Penguins plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (penguins.plugin.json)

Every plugin **must** ship a `penguins.plugin.json` file in the **plugin root**.
Penguins uses this manifest to validate configuration **without executing plugin
