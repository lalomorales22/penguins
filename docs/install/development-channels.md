...
Penguins ships three update channels:
...
When you **explicitly** switch channels with `--channel`, Penguins also aligns
the install method:
...
When you switch channels with `penguins update`, Penguins also syncs plugin sources:
