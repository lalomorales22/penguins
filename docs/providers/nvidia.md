---
summary: "Use NVIDIA's OpenAI-compatible API in Penguins"
read_when:
  - You want to use NVIDIA models in Penguins
...
penguins onboard --auth-choice skip
penguins models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
