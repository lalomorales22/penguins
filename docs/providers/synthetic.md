---
summary: "Use Synthetic's Anthropic-compatible API in Penguins"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. Penguins registers it as the
...
Note: Penguins's Anthropic client appends `/v1` to the base URL, so use
