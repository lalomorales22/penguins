...
You can point Penguins at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Penguins
...
- [Anthropic provider](/providers/anthropic) - Native Penguins integration with Claude setup-token or API keys
