---
summary: "Use Qwen OAuth (free tier) in Penguins"
read_when:
  - You want to use Qwen with Penguins
...
If you already logged in with the Qwen Code CLI, Penguins will sync credentials
