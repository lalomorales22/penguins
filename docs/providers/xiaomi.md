---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Penguins"
read_when:
  - You want Xiaomi MiMo models in Penguins
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Penguins uses
