---
summary: "Use Qianfan's unified API to access many models in Penguins"
read_when:
...
3. Penguins installed on your system
...
4. Copy the API key for use with Penguins

## CLI setup

```bash
penguins onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [Penguins Configuration](/gateway/configuration)
