---
summary: "Schema-accurate configuration examples for common Penguins setups"
read_when:
  - Learning how to configure Penguins
...
```json5
{
  ...
  session: {
    ...
    store: "~/.penguins/agents/default/sessions/sessions.json",
    maintenance: {
      mode: "warn",
      pruneAfter: "30d",
      maxEntries: 500,
