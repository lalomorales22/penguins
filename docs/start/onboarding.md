---
summary: "First-run onboarding flow for Penguins (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Penguins">
...
<Step title="CLI">
  ...
  The app can install the global `penguins` CLI via npm/pnpm so terminal
