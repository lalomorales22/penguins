...
本指南总结了在 Penguins 中开发 Pi 集成的合理工作流程。
...
状态存储在 Penguins 状态目录下。默认为 `~/.penguins`。如果设置了 `OPENCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.penguins.ai/testing
- https://docs.penguins.ai/start/getting-started
