...
- `OPENCLAW_CONFIG_DIR=...` (default: `~/.penguins`) mounted to `/home/node/.penguins`
- `OPENCLAW_WORKSPACE_DIR=...` (default: `~/.penguins/workspace`) mounted to `/home/node/.penguins/workspace`
