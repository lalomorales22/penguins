---
summary: "Frequently asked questions about Penguins setup, configuration, and usage"
title: "FAQ"
---
...
- [Quick start and first-run setup]
  ...
  - [What's the recommended way to install and set up Penguins?](#whats-the-recommended-way-to-install-and-set-up-penguins)
  ...
  - [I can't access docs.penguins.ai (SSL error). What now?](#i-cant-access-docspenguinsai-ssl-error-what-now)
  - [What's the difference between stable and beta?](#whats-the-difference-between-stable-and-beta)
  - [How do I install the beta version, and what's the difference between beta and dev?](#how-do-i-install-the-beta-version-and-whats-the-difference-between-beta-and-dev)
  - [How do I try the latest bits?](#how-do-i-try-the-latest-bits)
  - [How long does install and onboarding usually take?](#how-long-does-install-and-onboarding-usually-take)
  - [Installer stuck? How do I get more feedback?](#installer-stuck-how-do-i-get-more-feedback)
  - [Windows install says git not found or penguins not recognized](#windows-install-says-git-not-found-or-penguins-not-recognized)
  - [The docs didn't answer my question - how do I get a better answer?](#the-docs-didnt-answer-my-question-how-do-i-get-a-better-answer)
  - [How do I install Penguins on Linux?](#how-do-i-install-penguins-on-linux)
  - [How do I install Penguins on a VPS?](#how-do-i-install-penguins-on-a-vps)
  - [Where are the cloud/VPS install guides?](#where-are-the-cloudvps-install-guides)
  - [Can I ask Penguins to update itself?](#can-i-ask-penguins-to-update-itself)
  ...
  - [If I buy a Mac mini to run Penguins, can I connect it to my MacBook Pro?](#if-i-buy-a-mac-mini-to-run-penguins-can-i-connect-it-to-my-macbook-pro)
  - [Can I use Bun?](#can-i-use-bun)
  - [Telegram: what goes in `allowFrom`?](#telegram-what-goes-in-allowfrom)
  - [Can multiple people use one WhatsApp number with different Penguins instances?](#can-multiple-people-use-one-whatsapp-number-with-different-penguins-instances)
  - [Can I run a "fast chat" agent and an "Opus for coding" agent?](#can-i-run-a-fast-chat-agent-and-an-opus-for-coding-agent)
  - [Does Homebrew work on Linux?](#does-homebrew-work-on-linux)
  - [What's the difference between the hackable (git) install and npm install?](#whats-the-difference-between-the-hackable-git-install-and-npm-install)
  - [Can I switch between npm and git installs later?](#can-i-switch-between-npm-and-git-installs-later)
  - [Should I run the Gateway on my laptop or a VPS?](#should-i-run-the-gateway-on-my-laptop-or-a-vps)
  - [How important is it to run Penguins on a dedicated machine?](#how-important-is-it-to-run-penguins-on-a-dedicated-machine)
  - [What are the minimum VPS requirements and recommended OS?](#what-are-the-minimum-vps-requirements-and-recommended-os)
  - [Can I run Penguins in a VM and what are the requirements](#can-i-run-penguins-in-a-vm-and-what-are-the-requirements)
- [What is Penguins?](#what-is-penguins)
  - [What is Penguins, in one paragraph?](#what-is-penguins-in-one-paragraph)
  - [What's the value proposition?](#whats-the-value-proposition)
  - [I just set it up what should I do first](#i-just-set-it-up-what-should-i-do-first)
  - [What are the top five everyday use cases for Penguins](#what-are-the-top-five-everyday-use-cases-for-penguins)
  - [Can Penguins help with lead gen outreach ads and blogs for a SaaS](#can-penguins-help-with-lead-gen-outreach-ads-and-blogs-for-a-saas)
...
- [Skills and automation](#skills-and-automation)
  ...
  - [Can Penguins run tasks on a schedule or continuously in the background?](#can-penguins-run-tasks-on-a-schedule-or-continuously-in-the-background)
...
- [Where things live on disk](#where-things-live-on-disk)
  - [Is all data used with Penguins saved locally?](#is-all-data-used-with-penguins-saved-locally)
  - [Where does Penguins store its data?](#where-does-penguins-store-its-data)
  - [Where should AGENTS.md / SOUL.md / USER.md / MEMORY.md live?](#where-should-agentsmd-soulmd-usermd-memorymd-live)
  - [What's the recommended backup strategy?](#whats-the-recommended-backup-strategy)
  - [How do I completely uninstall Penguins?](#how-do-i-completely-uninstall-penguins)
...
- [Config basics](#config-basics)
  ...
  - [Can the Penguins browser run headless?](#can-the-penguins-browser-run-headless)
...
- [Remote gateways and nodes](#remote-gateways-and-nodes)
  ...
  - [Can two Penguins instances talk to each other (local + VPS)?](#can-two-penguins-instances-talk-to-each-other-local-vps)
...
- [Env vars and .env loading](#env-vars-and-env-loading)
  - [How does Penguins load environment variables?](#how-does-penguins-load-environment-variables)
...
- [Sessions and multiple chats](#sessions-and-multiple-chats)
  ...
  - [Is there a way to make a team of Penguins instances one CEO and many agents](#is-there-a-way-to-make-a-team-of-penguins-instances-one-ceo-and-many-agents)
  - [Why did context get truncated mid-task? How do I prevent it?](#why-did-context-get-truncated-midtask-how-do-i-prevent-it)
  - [How do I completely reset Penguins but keep it installed?](#how-do-i-completely-reset-penguins-but-keep-it-installed)
  ...
  - [Why doesn't Penguins reply in a group?](#why-doesnt-penguins-reply-in-a-group)
...
- [Models: defaults, selection, aliases, switching](#models-defaults-selection-aliases-switching)
  ...
  - [What do Penguins, Flawd, and Krill use for models?](#what-do-penguins-flawd-and-krill-use-for-models)
...
- [Gateway: ports, "already running", and remote mode](#gateway-ports-already-running-and-remote-mode)
  ...
  - [Why does `penguins gateway status` say `Runtime: running` but `RPC probe: failed`?](#why-does-penguins-gateway-status-say-runtime-running-but-rpc-probe-failed)
  - [Why does `penguins gateway status` show `Config (cli)` and `Config (service)` different?](#why-does-penguins-gateway-status-show-config-cli-and-config-service-different)
  - [What does "another gateway instance is already listening" mean?](#what-does-another-gateway-instance-is-already-listening-mean)
  - [How do I run Penguins in remote mode (client connects to a Gateway elsewhere)?](#how-do-i-run-penguins-in-remote-mode-client-connects-to-a-gateway-elsewhere)
...
- [Logging and debugging](#logging-and-debugging)
  ...
  - [I closed my terminal on Windows - how do I restart Penguins?](#i-closed-my-terminal-on-windows-how-do-i-restart-penguins)
  ...
  - [ELI5: `penguins gateway restart` vs `penguins gateway`](#eli5-penguins-gateway-restart-vs-penguins-gateway)
  - [What's the fastest way to get more details when something fails?](#whats-the-fastest-way-to-get-more-details-when-something-fails)
- [Media and attachments](#media-and-attachments)
  - [My skill generated an image/PDF, but nothing was sent](#my-skill-generated-an-imagepdf-but-nothing-was-sent)
- [Security and access control](#security-and-access-control)
  - [Is it safe to expose Penguins to inbound DMs?](#is-it-safe-to-expose-penguins-to-inbound-dms)
...
5. **Tail the latest log**
   ...
   ```bash
   tail -f "$(ls -t /tmp/penguins/penguins-*.log | head -1)"
   ```
...
7. **Gateway snapshot**
   ...
   penguins health --verbose   # shows the target URL + config path on errors
   ```
...
```bash
curl -fsSL https://penguins.ai/install.sh | bash -s -- --install-method git
```

This installs Penguins **from a git checkout**, so the agent can read the code + docs and
...
[https://github.com/penguins/penguins/issues](https://github.com/penguins/penguins/issues)
[https://github.com/penguins/penguins/pulls](https://github.com/penguins/penguins/pulls)
...
- `penguins status`: quick snapshot of gateway/agent health + basic config.
- `penguins models status`: checks provider auth + model availability.
- `penguins doctor`: validates and repairs common config/state issues.

Other useful CLI checks: `penguins status --all`, `penguins logs --follow`,
`penguins gateway status`, `penguins health --verbose`.

Quick debug loop: [First 60 seconds if something's broken](#first-60-seconds-if-somethings-broken).
Install docs: [Install](/install), [Installer flags](/install/installer), [Updating](/install/updating).

### What's the recommended way to install and set up Penguins
...
If you don't have a global install yet, run it via `pnpm penguins onboard`.
...
under `~/.penguins/` (for example `~/.penguins/agents/<agentId>/sessions/`).

Related: [Migrating](/install/migrating), [Where things live on disk](/help/faq#where-does-penguins-store-its-data),
...
[https://github.com/penguins/penguins/blob/main/CHANGELOG.md](https://github.com/penguins/penguins/blob/main/CHANGELOG.md)

Newest entries are at the top. If the top section is marked **Unreleased**, the next dated
section is the latest shipped version. Entries are grouped by **Highlights**, **Changes**, and
**Fixes** (plus docs/other sections when needed).

### I cant access docs.penguins.ai SSL error What now

Some Comcast/Xfinity connections incorrectly block `docs.penguins.ai` via Xfinity
Advanced Security. Disable it or allowlist `docs.penguins.ai`, then retry. More
detail: [Troubleshooting](/help/troubleshooting#docspenguinsai-shows-an-ssl-error-comcastxfinity).
Please help us unblock it by reporting here: [https://spa.xfinity.com/check_url_status](https://spa.xfinity.com/check_url_status).

If you still can't reach the site, the docs are mirrored on GitHub:
[https://github.com/penguins/penguins/tree/main/docs](https://github.com/penguins/penguins/tree/main/docs)
...
```bash
curl -fsSL --proto '=https' --tlsv1.2 https://penguins.ai/install.sh | bash -s -- --beta
```

```bash
curl -fsSL --proto '=https' --tlsv1.2 https://penguins.ai/install.sh | bash -s -- --install-method git
```

Windows installer (PowerShell):
[https://penguins.ai/install.ps1](https://penguins.ai/install.ps1)
...
```bash
curl -fsSL https://penguins.ai/install.sh | bash -s -- --verbose
```

Beta install with verbose:

```bash
curl -fsSL https://penguins.ai/install.sh | bash -s -- --beta --verbose
```

For a hackable (git) install:

```bash
curl -fsSL https://penguins.ai/install.sh | bash -s -- --install-method git --verbose
```
...
Set-PSDebug -Trace 1
& ([scriptblock]::Create((iwr -useb https://penguins.ai/install.ps1))) -NoOnboard
Set-PSDebug -Trace 0
```

More options: [Installer flags](/install/installer).

### Windows install says git not found or penguins not recognized
...
**2) penguins is not recognized after install**
...
### How do I install Penguins on Linux
...
### How do I install Penguins on a VPS
...
### Can I ask Penguins to update itself
...
```bash
penguins update
penguins update status
penguins update --channel stable|beta|dev
penguins update --tag <dist-tag|version>
penguins update --no-restart
```

If you must automate from an agent:

```bash
penguins update --yes --no-restart
penguins gateway restart
```
...
`penguins onboard` is the recommended setup path. In **local mode** it walks you through:
...
No. You can run Penguins with **API keys** (Anthropic/OpenAI/others) or with
...
`claude setup-token` generates a **token string** via the Claude Code CLI (it is not available in the web console). You can run it on **any machine**. Choose **Anthropic token (paste setup-token)** in the wizard or paste it with `penguins models auth paste-token --provider anthropic`. The token is stored as an auth profile for the **anthropic** provider and used like an API key (no auto-refresh). More detail: [OAuth](/concepts/oauth).
...
Copy the token it prints, then choose **Anthropic token (paste setup-token)** in the wizard. If you want to run it on the gateway host, use `penguins models auth setup-token --provider anthropic`. If you ran `claude setup-token` elsewhere, paste it on the gateway host with `penguins models auth paste-token --provider anthropic`. See [Anthropic](/providers/anthropic).

### Do you support Claude subscription auth (Claude Pro or Max)

Yes - via **setup-token**. Penguins no longer reuses Claude Code CLI OAuth tokens; use a setup-token or an Anthropic API key. Generate the token anywhere and paste it on the gateway host. See [Anthropic](/providers/anthropic) and [OAuth](/concepts/oauth).
...
Tip: set a **fallback model** so Penguins can keep replying while a provider is rate-limited.
...
Penguins supports **OpenAI Code (Codex)** via OAuth (ChatGPT sign-in). The wizard can run the OAuth flow and will set the default model to `openai-codex/gpt-5.3-codex` when appropriate. See [Model providers](/concepts/model-providers) and [Wizard](/start/wizard).

### Do you support OpenAI subscription auth Codex OAuth

Yes. Penguins fully supports **OpenAI Code (Codex) subscription OAuth**. The onboarding wizard
...
Gemini CLI uses a **plugin auth flow**, not a client id or secret in `penguins.json`.

Steps:

1. Enable the plugin: `penguins plugins enable google-gemini-cli-auth`
2. Login: `penguins models auth login --provider google-gemini-cli --set-default`

This stores OAuth tokens in auth profiles on the gateway host. Details: [Model providers](/concepts/model-providers).

### Is a local model OK for casual chats

Usually no. Penguins needs large context + strong safety; small cards truncate and leak. If you must, run the **largest** MiniMax M2.1 build you can locally (LM Studio) and see [/gateway/local-models](/gateway/local-models). Smaller/quantized models increase prompt-injection risk - see [Security](/gateway/security).
...
No. Penguins runs on macOS or Linux (Windows via WSL2). A Mac mini is optional - some people
...
### If I buy a Mac mini to run Penguins can I connect it to my MacBook Pro
...
- Use `penguins nodes status` / `penguins nodes list` to see it.
...
The onboarding wizard accepts `@username` input and resolves it to a numeric ID, but Penguins authorization uses numeric IDs only.

Safer (no third-party bot):

- DM your bot, then run `penguins logs --follow` and read `from.id`.
...
### Can multiple people use one WhatsApp number with different Penguins instances
...
If you run Penguins via systemd, ensure the service PATH includes `/home/linuxbrew/.linuxbrew/bin` (or your brew prefix) so `brew`-installed tools resolve in non-login shells.
...
This **does not delete your data** - it only changes the Penguins code install. Your state
(`~/.penguins`) and workspace (`~/.penguins/workspace`) stay untouched.
...
**Penguins-specific note:** WhatsApp/Telegram/Slack/Mattermost (plugin)/Discord all work fine from a VPS. The only real trade-off is **headless browser** vs a visible window. See [Browser](/tools/browser).

**Recommended default:** VPS if you had gateway disconnects before. Local is great when you're actively using the Mac and want local file access or UI automation with a visible browser.

### How important is it to run Penguins on a dedicated machine
...
Penguins is lightweight. For a basic Gateway + one chat channel:
...
### Can I run Penguins in a VM and what are the requirements
...
### What are the top five everyday use cases for Penguins
...
Penguins draft and you approve.

Docs: [Security](/gateway/security).

### What are the advantages vs Claude Code for web development

Penguins is a **personal assistant** and coordination layer, not an IDE replacement. Use
Claude Code or Codex for the fastest direct coding loop inside a repo. Use Penguins when you
...
Use managed overrides instead of editing the repo copy. Put your changes in `~/.penguins/skills/<name>/SKILL.md` (or add a folder via `skills.load.extraDirs` in `~/.penguins/penguins.json`). Precedence is `<workspace>/skills` > `~/.penguins/skills` > bundled, so managed overrides win without touching git. Only upstream-worthy edits should live in the repo and go out as PRs.

### Can I load skills from a custom folder

Yes. Add extra directories via `skills.load.extraDirs` in `~/.penguins/penguins.json` (lowest precedence). Default precedence remains: `<workspace>/skills` → `~/.penguins/skills` → bundled → `skills.load.extraDirs`. `clawhub` installs into `./skills` by default, which Penguins treats as `<workspace>/skills`.
...
```bash
penguins cron run <jobId> --force
penguins cron runs --id <jobId> --limit 50
```
...
### Can Penguins run tasks on a schedule or continuously in the background
...
Not directly. macOS skills are gated by `metadata.penguins.os` plus required binaries, and skills only appear in the system prompt when they are eligible on the **Gateway host**. On Linux, `darwin`-only skills (like `apple-notes`, `apple-reminders`, `things-mac`) will not load unless you override the gating.

You have three supported patterns:

**Option A - run the Gateway on a Mac (simplest).**
Run the Gateway where the macOS binaries exist, then connect from Linux in [remote mode](#how-do-i-run-penguins-in-remote-mode-client-connects-to-a-gateway-elsewhere) or over Tailscale. The skills load normally because the Gateway host is macOS.

**Option B - use a macOS node (no SSH).**
Run the Gateway on Linux, pair a macOS node (menubar app), and set **Node Run Commands** to "Always Ask" or "Always Allow" on the Mac. Penguins can treat macOS-only skills as eligible when the required binaries exist on the node. The agent runs those skills via the `nodes` tool. If you choose "Always Ask", approving "Always Allow" in the prompt adds that command to the allowlist.
...
3. Override the skill metadata (workspace or `~/.penguins/skills`) to allow Linux:

   ```markdown
   ---
   name: apple-notes
   description: Manage Apple Notes via the memo CLI on macOS.
   metadata: { "penguins": { "os": ["darwin", "linux"], "requires": { "bins": ["memo"] } } }
   ---
   ```
...
ClawHub installs into `./skills` under your current directory (or falls back to your configured Penguins workspace); Penguins treats that as `<workspace>/skills` on the next session. For shared skills across agents, place them in `~/.penguins/skills/<name>/SKILL.md`. Some skills expect binaries installed via Homebrew; on Linux that means Linuxbrew (see the Homebrew Linux FAQ entry above). See [Skills](/tools/skills) and [ClawHub](/tools/clawhub).
...
Penguins memory is just Markdown files in the agent workspace:

- Daily notes in `memory/YYYY-MM-DD.md`
- Curated long-term notes in `MEMORY.md` (main/private sessions only)

Penguins also runs a **silent pre-compaction memory flush** to remind the model
...
If you don't set a provider explicitly, Penguins auto-selects a provider when it
can resolve an API key (auth profiles, `models.providers.*.apiKey`, or env vars).
It prefers OpenAI if an OpenAI key resolves, otherwise Gemini if a Gemini key
resolves. If neither key is available, memory search stays disabled until you
configure it. If you have a local model path configured and present, Penguins
prefers `local`.
...
### Is all data used with Penguins saved locally

No - **Penguins's state is local**, but **external services still see what you send them**.

- **Local by default:** sessions, memory files, config, and workspace live on the Gateway host
  (`~/.penguins` + your workspace directory).
...
Your **workspace** (AGENTS.md, memory files, skills, etc.) is separate and configured via `agents.defaults.workspace` (default: `~/.penguins/workspace`).

### Where should AGENTSmd SOULmd USERmd MEMORYmd live

These files live in the **agent workspace**, not `~/.penguins`.

- **Workspace (per agent)**: `AGENTS.md`, `SOUL.md`, `IDENTITY.md`, `USER.md`,
  `MEMORY.md` (or `memory.md`), `memory/YYYY-MM-DD.md`, optional `HEARTBEAT.md`.
- **State dir (`~/.penguins`)**: config, credentials, auth profiles, sessions, logs,
  and shared skills (`~/.penguins/skills`).

Default workspace is `~/.penguins/workspace`, configurable via:
...
Do **not** commit anything under `~/.penguins` (credentials, sessions, tokens).
If you need a full restore, back up both the workspace and the state directory
separately (see the migration question above).

Docs: [Agent workspace](/concepts/agent-workspace).

### How do I completely uninstall Penguins
...
`workspace` to the repo root. The Penguins repo is just source code; keep the
...
If you **really** want open loopback, remove `gateway.auth` from your config. Doctor can generate a token for you any time: `penguins doctor --generate-gateway-token`.
...
key. **Recommended:** run `penguins configure --section web` to store it in
...
- Daemons read env vars from `~/.penguins/.env` (or the service environment).
...
### Can the Penguins browser run headless
...
5. Approve the node on the Gateway:
   ...
   ```bash
   penguins nodes pending
   penguins nodes approve <requestId>
   ```
...
### Can two Penguins instances talk to each other local VPS
...
`penguins agent --message ... --deliver`, targeting a chat where the other bot
...
```bash
penguins agent --message "Hello from local bot" --deliver --channel telegram --reply-to <chat-id>
```
...
- Restore from backup (git or a copied `~/.penguins/penguins.json`).
- If you have no backup, re-run `penguins doctor` and reconfigure channels/models.
- If this was unexpected, file a bug and include your last known config or any backup.
- A local coding agent can often reconstruct a working config from logs or history.

Avoid it:

- Use `penguins config set` for small changes.
- Use `penguins configure` for interactive edits.
...
### How does Penguins load environment variables
...
1. Put the missing keys in `~/.penguins/.env` so they're picked up even when the service doesn't inherit your shell env.
...
`penguins models status` reports whether **shell env import** is enabled. "Shell env: off"
does **not** mean your env vars are missing - it just means Penguins won't load
your login shell automatically.

If the Gateway runs as a service (launchd/systemd), it won't inherit your shell
environment. Fix by doing one of these:

1. Put the token in `~/.penguins/.env`:
...
### Is there a way to make a team of Penguins instances one CEO and many agents
...
### How do I completely reset Penguins but keep it installed
...
```bash
penguins reset --scope full --yes --non-interactive
```
...
No. Penguins runs on **your own account**, so if you're in the group, Penguins can see it.
...
```bash
penguins directory groups list --channel whatsapp
```

Docs: [WhatsApp](/channels/whatsapp), [Directory](/cli/directory), [Logs](/cli/logs).

### Why doesnt Penguins reply in a group
...
- **Disk growth:** sessions + transcripts live under `~/.penguins/agents/<agentId>/sessions/`.
...
- Use `penguins doctor` to spot stray workspaces and profile mismatches.
...
Penguins's default model is whatever you set as:

```
agents.defaults.model.primary
```

Models are referenced as `provider/model` (example: `anthropic/claude-opus-4-6`). If you omit the provider, Penguins currently assumes `anthropic` as a temporary deprecation fallback - but you should still **explicitly** set `provider/model`.
...
- `penguins models set ...` (updates just model config)
- `penguins configure --section model` (interactive)
- edit `agents.defaults.model` in `~/.penguins/penguins.json`

Avoid `config.apply` with a partial object unless you intend to replace the whole config.
If you did overwrite config, restore from backup or re-run `penguins doctor` to repair.

Docs: [Models](/concepts/models), [Configure](/cli/configure), [Config](/cli/config), [Doctor](/gateway/doctor).

### What do Penguins, Flawd, and Krill use for models

- **Penguins + Flawd:** Anthropic Opus (`anthropic/claude-opus-4-6`) - see [Anthropic](/providers/anthropic).
...
Yes. Penguins ships a few default shorthands (only applied when the model exists in `agents.defaults.models`):
...
```
~/.penguins/agents/<agentId>/agent/auth-profiles.json
```

Fix options:

- Run `penguins agents add <id>` and configure auth during the wizard.
...
Cooldowns apply to failing profiles (exponential backoff), so Penguins can keep responding even when a provider is rate-limited or temporarily failing.
...
- **Confirm where auth profiles live** (new vs legacy paths)
  - Current: `~/.penguins/agents/<agentId>/agent/auth-profiles.json`
  - Legacy: `~/.penguins/agent/*` (migrated by `penguins doctor`)
- **Confirm your env var is loaded by the Gateway**
  - If you set `ANTHROPIC_API_KEY` in your shell but run the Gateway via systemd/launchd, it may not inherit it. Put it in `~/.penguins/.env` or enable `env.shellEnv`.
- **Make sure you're editing the correct agent**
  - Multi-agent setups mean there can be multiple `auth-profiles.json` files.
- **Sanity-check model/auth status**
  - Use `penguins models status` to see configured models and whether providers are authenticated.
...
- **Use a setup-token**
  - Run `claude setup-token`, then paste it with `penguins models auth setup-token --provider anthropic`.
  - If the token was created on another machine, use `penguins models auth paste-token --provider anthropic`.
- **If you want to use an API key instead**
  - Put `ANTHROPIC_API_KEY` in `~/.penguins/.env` on the **gateway host**.
  - Clear any pinned order that forces a missing profile:

    ```bash
    penguins models auth order clear --provider anthropic
    ```
...
If your model config includes Google Gemini as a fallback (or you switched to a Gemini shorthand), Penguins will try it during model fallback. If you haven't configured Google credentials, you'll see `No API key found for provider "google"`.
...
Fix: Penguins now strips unsigned thinking blocks for Google Antigravity Claude. If it still appears, start a **new session** or set `/thinking off` for that agent.
...
Penguins uses provider-prefixed IDs like:
...
Penguins may temporarily skip a profile if it's in a short **cooldown** (rate limits/timeouts/auth failures) or a longer **disabled** state (billing/insufficient credits). To inspect this, run `penguins models status --json` and check `auth.unusableProfiles`. Tuning: `auth.cooldowns.billingBackoffHours*`.

You can also set a **per-agent** order override (stored in that agent's `auth-profiles.json`) via the CLI:

```bash
# Defaults to the configured default agent (omit --agent)
penguins models auth order get --provider anthropic

# Lock rotation to a single profile (only try this one)
penguins models auth order set --provider anthropic anthropic:default

# Or set an explicit order (fallback within provider)
penguins models auth order set --provider anthropic anthropic:work anthropic:default
...
```bash
penguins models auth order set --provider anthropic --agent main anthropic:default
```

### OAuth vs API key whats the difference

Penguins supports both:
...
Use `penguins gateway status` and trust these lines:
...
```bash
penguins gateway install --force
```
...
Penguins enforces a runtime lock by binding the WebSocket listener immediately on startup (default `ws://127.0.0.1:18789`). If the bind fails with `EADDRINUSE`, it throws `GatewayLockError` indicating another instance is already listening.

Fix: stop the other instance, free the port, or run with `penguins gateway --port <port>`.

### How do I run Penguins in remote mode client connects to a Gateway elsewhere
...
- `penguins gateway` only starts when `gateway.mode` is `local` (or you pass the override flag).
...
- The Control UI stores the token in browser localStorage key `penguins.control.settings.v1`.
...
- Use `penguins --profile <name> …` per instance (auto-creates `~/.penguins-<name>`).
...
```
penguins tui --url ws://<host>:18789 --token <token>
```
...
```
/tmp/penguins/penguins-YYYY-MM-DD.log
```
...
If you run the gateway manually, `penguins gateway --force` can reclaim the port. See [Gateway](/gateway).

### I closed my terminal on Windows how do I restart Penguins
...
1. Is the Gateway running? `penguins gateway status`
2. Is the Gateway healthy? `penguins status`
3. Does the UI have the right token? `penguins dashboard`
...
### ELI5 penguins gateway restart vs penguins gateway

- `penguins gateway restart`: restarts the **background service** (launchd/systemd).
- `penguins gateway`: runs the gateway **in the foreground** for this terminal session.

If you installed the service, use the gateway commands. Use `penguins gateway` when
...
Outbound attachments from the agent must include a `MEDIA:<path-or-url>` line (on its own line). See [Penguins assistant setup](/start/penguins) and [Agent send](/tools/agent-send).

CLI sending:

```bash
penguins message send --target +15555550123 --message "Here you go" --media /path/to/file.png
```
...
### Is it safe to expose Penguins to inbound DMs

Treat inbound DMs as untrusted input. Defaults are designed to reduce risk:

- Default behavior on DM-capable channels is **pairing**:
  - Unknown senders receive a pairing code; the bot does not process their message.
  - Approve with: `penguins pairing approve <channel> <code>`
  - Pending requests are capped at **3 per channel**; check `penguins pairing list <channel>` if a code didn't arrive.
- Opening DMs publicly requires explicit opt-in (`dmPolicy: "open"` and allowlist `"*"`).

Run `penguins doctor` to surface risky DM policies.
...
```bash
penguins pairing list telegram
```
...
No. Default WhatsApp DM policy is **pairing**. Unknown senders only get a pairing code and their message is **not processed**. Penguins only replies to chats it receives or to explicit sends you trigger.

Approve pairing with:

```bash
penguins pairing approve whatsapp <code>
```

List pending requests:

```bash
penguins pairing list whatsapp
```
...
Penguins blocks **cross-provider** messaging by default. If a tool call is bound
