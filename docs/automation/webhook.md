...
read_when:
  ...
  - Wiring external systems into Penguins
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your Penguins config directory (typically `~/.penguins/hooks/transforms`).
...
- `penguins webhooks gmail setup` writes `hooks.gmail` config for `penguins webhooks gmail run`.
