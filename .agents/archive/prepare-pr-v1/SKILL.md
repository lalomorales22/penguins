...
- `fix: <summary> (penguins#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (penguins#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "penguins#$pr_number" || { echo "ERROR: commit subject missing penguins#$pr_number"; exit 1; }
