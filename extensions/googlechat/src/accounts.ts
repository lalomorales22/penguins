...
export function listGoogleChatAccountIds(cfg: PenguinsConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: PenguinsConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: PenguinsConfig): ResolvedGoogleChatAccount[] {
