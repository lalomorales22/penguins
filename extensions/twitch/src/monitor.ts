...
import type { ReplyPayload, PenguinsConfig } from "penguins/plugin-sdk";
import { createReplyPrefixOptions } from "penguins/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as PenguinsConfig;
