...
Nostr DM channel plugin for Penguins using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to Penguins. It enables your bot to:
...
# Configure penguins to use local relay
