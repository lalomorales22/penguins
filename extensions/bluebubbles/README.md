...
This directory contains the **BlueBubbles external channel plugin** for Penguins.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `penguins/plugin-sdk` helpers.
