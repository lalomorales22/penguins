...
import { resolveChannelMediaMaxBytes, type PenguinsConfig } from "penguins/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: PenguinsConfig; accountId?: string }): string[] {
