...
export function listMattermostAccountIds(cfg: PenguinsConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: PenguinsConfig): string {
...
export function listEnabledMattermostAccounts(cfg: PenguinsConfig): ResolvedMattermostAccount[] {
