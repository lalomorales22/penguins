import type { ChannelOnboardingAdapter, PenguinsConfig, WizardPrompter } from "penguins/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.penguins.ai/channels/mattermost",
    ].join("\n"),
