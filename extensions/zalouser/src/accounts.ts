...
export function listZalouserAccountIds(cfg: PenguinsConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: PenguinsConfig): string {
...
function mergeZalouserAccountConfig(cfg: PenguinsConfig, accountId: string): ZalouserAccountConfig {
