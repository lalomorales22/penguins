...
import { approveDevicePairing, listDevicePairing } from "penguins/plugin-sdk";
...
async function resolveTailnetHost(api: PenguinsPluginApi): Promise<string | null> {
...
async function resolveGatewayUrl(api: PenguinsPluginApi): Promise<ResolveUrlResult> {
