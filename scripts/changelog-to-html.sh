...
if [[ -z "$version_content" ]]; then
  echo "<h2>Penguins $VERSION</h2>"
  echo "<p>Latest Penguins update.</p>"
  echo "<p><a href=\"https://github.com/penguins/penguins/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
