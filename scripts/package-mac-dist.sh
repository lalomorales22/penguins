...
# Output:
# - dist/Penguins.app
# - dist/Penguins-<version>.zip
# - dist/Penguins-<version>.dmg
...
APP="$ROOT_DIR/dist/Penguins.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/Penguins-$VERSION.zip"
DMG="$ROOT_DIR/dist/Penguins-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Penguins-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Penguins-$VERSION.dSYM.zip"
