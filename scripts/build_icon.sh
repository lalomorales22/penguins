...
# Defaults target the Penguins assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/Penguins/Resources/Penguins.icns"}
