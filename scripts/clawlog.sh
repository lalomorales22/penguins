...
show_usage() {
    cat << EOF
clawlog - Penguins Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View Penguins logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    Penguins logs flow through the macOS unified log (subsystem: ai.penguins).
