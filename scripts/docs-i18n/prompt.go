...
- Keep product names in English: Penguins, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the Penguins Gateway, use “Gateway 网关”.
