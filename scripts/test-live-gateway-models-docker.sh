...
docker run --rm -t \
  ...
  -e PENGUINS_LIVE_GATEWAY_MODELS="${PENGUINS_LIVE_GATEWAY_MODELS:-${PENGUINS_LIVE_GATEWAY_MODELS:-all}}" \
  -e PENGUINS_LIVE_GATEWAY_PROVIDERS="${PENGUINS_LIVE_GATEWAY_PROVIDERS:-${PENGUINS_LIVE_GATEWAY_PROVIDERS:-}}" \
  -e PENGUINS_LIVE_GATEWAY_MODEL_TIMEOUT_MS="${PENGUINS_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-${PENGUINS_LIVE_GATEWAY_MODEL_TIMEOUT_MS:-}}" \
