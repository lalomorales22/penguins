...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = PenguinsLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = PenguinsLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.penguins.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(PenguinsLocationMode.off.rawValue)
                            Text("While Using").tag(PenguinsLocationMode.whileUsing.rawValue)
                            Text("Always").tag(PenguinsLocationMode.always.rawValue)
                        }
                        ...
                        Text("Keeps the screen awake while Penguins is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = PenguinsLocationMode(rawValue: newValue) else { return }
                Task {
    ...
    private var locationMode: PenguinsLocationMode {
        PenguinsLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
