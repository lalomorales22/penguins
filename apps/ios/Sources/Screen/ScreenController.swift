...
final class ScreenController {
    ...
    /// Callback invoked when an penguins:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = PenguinsKitResources.bundle
...
/// Handles navigation policy to intercept penguins:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept penguins:// deep links.
        if url.scheme?.lowercased() == "penguins" {
