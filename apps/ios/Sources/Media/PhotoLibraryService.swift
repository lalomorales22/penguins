...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: PenguinsPhotosLatestParams) async throws -> PenguinsPhotosLatestPayload {
        ...
        var results: [PenguinsPhotoPayload] = []
        ...
        return PenguinsPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> PenguinsPhotoPayload
    {
