...
enum PenguinsConfigFile {
    private static let logger = Logger(subsystem: "ai.penguins", category: "config")
    ...
    static func stateDirURL() -> URL {
        PenguinsPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        PenguinsPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-penguins-config-file",
            "event": "config.write",
