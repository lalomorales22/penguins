...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = PenguinsConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = PenguinsConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = PenguinsConfigFile.loadDict()
            ...
            PenguinsConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/penguins"
        state.remoteCliPath = ""
        return state
    }
}
