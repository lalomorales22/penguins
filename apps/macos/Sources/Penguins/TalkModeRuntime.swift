...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.penguins", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.penguins", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [PenguinsChatMessage] = messages.compactMap { item in
