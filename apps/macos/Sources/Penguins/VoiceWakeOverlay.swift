...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.penguins", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other Penguins windows, but below the system’s pop-up menus.
