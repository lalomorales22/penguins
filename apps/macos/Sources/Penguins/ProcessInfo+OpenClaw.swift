...
extension ProcessInfo {
    ...
    /// Nix deployments may write defaults into a stable suite (`ai.penguins.mac`) even if the shipped
        ...
        isAppBundle: Bool) -> Bool
    {
        ...
        if standard.bool(forKey: "penguins.nixMode") { return true }
        ...
        if isAppBundle, let stableSuite, stableSuite.bool(forKey: "penguins.nixMode") { return true }
