...
enum UIStrings {
    static let welcomeTitle = "Welcome to Penguins"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "penguins.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: PenguinsOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: PenguinsChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g penguins@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: PenguinsChatViewModel(
