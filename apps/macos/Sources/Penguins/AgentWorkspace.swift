...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.penguins", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return PenguinsConfigFile.defaultWorkspaceURL() }
