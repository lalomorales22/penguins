...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/penguins/penguins") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/penguins/penguins")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://penguins.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "PenguinsBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "PenguinsBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "PenguinsGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "PenguinsGitCommit") as? String) ??
            "unknown"
    }
