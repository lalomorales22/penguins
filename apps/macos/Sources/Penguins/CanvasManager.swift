...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.penguins", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("Penguins/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__penguins__/a2ui/").absoluteString + "?platform=macos"
    }
