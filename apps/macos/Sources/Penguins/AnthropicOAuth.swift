...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (Penguins token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: PenguinsOAuthStore.AnthropicOAuthStatus = PenguinsOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.penguins", category: "anthropic-oauth")
...
enum PenguinsOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let penguinsOAuthDirEnv = "OPENCLAW_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "Penguins OAuth token file not found"
            case .unreadableFile: "Penguins OAuth token file not readable"
            case .invalidJSON: "Penguins OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in Penguins OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "Penguins OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.penguinsOAuthDirEnv]?
        ...
        return home.appendingPathComponent(".penguins", isDirectory: true)
