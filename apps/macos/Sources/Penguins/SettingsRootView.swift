...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .penguinsSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? PenguinsPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? PenguinsPaths.stateDirURL.path
...
extension Notification.Name {
    static let penguinsSelectSettingsTab = Notification.Name("penguinsSelectSettingsTab")
}
