...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.penguins", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".penguins/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.penguinsCommand(
            subcommand: "gateway",
