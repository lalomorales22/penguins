## Penguins Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_penguins-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm penguins gateway --port 18789 --verbose
```
