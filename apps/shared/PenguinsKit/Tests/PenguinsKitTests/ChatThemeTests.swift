...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = PenguinsChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = PenguinsChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
