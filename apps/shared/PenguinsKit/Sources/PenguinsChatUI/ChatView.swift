...
@MainActor
public struct PenguinsChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: PenguinsChatViewModel
    ...
    public init(
        viewModel: PenguinsChatViewModel,
    ...
    private var visibleMessages: [PenguinsChatMessage] {
        let base: [PenguinsChatMessage]
    ...
    private func mergeToolResults(in messages: [PenguinsChatMessage]) -> [PenguinsChatMessage] {
        ...
        for message in messages {
            ...
            let merged = PenguinsChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: PenguinsChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: PenguinsChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: PenguinsChatMessage) -> String {
