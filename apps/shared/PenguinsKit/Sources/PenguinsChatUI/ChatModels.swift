...
public typealias PenguinsPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias PenguinsPlatformImage = UIImage
#endif

public struct PenguinsChatUsageCost: Codable, Hashable, Sendable {
...
public struct PenguinsChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: PenguinsChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(PenguinsChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct PenguinsChatMessageContent: Codable, Hashable, Sendable {
...
public struct PenguinsChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [PenguinsChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: PenguinsChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [PenguinsChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: PenguinsChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(PenguinsChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([PenguinsChatMessageContent].self, forKey: .content) {
...
public struct PenguinsChatHistoryPayload: Codable, Sendable {
...
public struct PenguinsSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct PenguinsSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [PenguinsSessionPreviewItem]
}

public struct PenguinsSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [PenguinsSessionPreviewEntry]

    public init(ts: Int, previews: [PenguinsSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct PenguinsChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct PenguinsChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct PenguinsAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct PenguinsChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct PenguinsGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct PenguinsPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: PenguinsPlatformImage?
...
public struct PenguinsChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
