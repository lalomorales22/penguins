...
public enum PenguinsTalkCommand: String, Codable, Sendable {
...
public struct PenguinsTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct PenguinsTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
