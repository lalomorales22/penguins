...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.penguins", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.penguins", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: PenguinsProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
