...
public enum PenguinsCanvasA2UICommand: String, Codable, Sendable {
...
public struct PenguinsCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct PenguinsCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
